...
import com.inn.restaurant.com.inn.restaurant.service.ProductService;
import com.inn.restaurant.com.inn.restaurant.utils.RestaurantUtils;
import com.inn.restaurant.com.inn.restaurant.wrapper.ProductWrapper;
        ...
        try {
            if (jwtFilter.isAdmin()) {
                if (validateProductMap(requestMap, false)) {
                    ...
                    return RestaurantUtils.getResponseEntity("Product added Succ", HttpStatus.OK);
                }
            ...
            if (jwtFilter.isAdmin()) {
                if (validateProductMap(requestMap, true)) {
                    ...
                    if (!optional.isEmpty()) {
                        ...
                        return RestaurantUtils.getResponseEntity("Product uppdated Succ", HttpStatus.OK);
                    } else {
                        return RestaurantUtils.getResponseEntity("Product Id nu exista", HttpStatus.OK);
                    }
                }
                return RestaurantUtils.getResponseEntity(RestaurantConstants.INVALID_DATA, HttpStatus.BAD_REQUEST);
            } else
        ...
        try {
            if (jwtFilter.isAdmin()) {
                ...
                if (!optional.isEmpty()) {
                    ...
                    return RestaurantUtils.getResponseEntity("Product deleted succ", HttpStatus.OK);
                } else
